# API_Money_Exchange (환전신청 API서비스)
...
![image](https://user-images.githubusercontent.com/51771396/115506980-796f0a80-a2b6-11eb-91f2-2cb04c123728.png)
...
##### 2.1 환전시원화금액조회 HTTP Request

```
POST /oai/wb/v1/exchange/getExchangeAmount
```
